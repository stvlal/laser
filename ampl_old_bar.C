...
void ampl_old_bar()
{
    ...
    TCanvas *c5 = new TCanvas("amplitudes","amplitudes",500,500);
    ...
    TLatex  *l2 = new TLatex(position[1]-5.,ampl1[1]-40.,Form("%i",2));
        l2->SetTextSize(0.035);
        l2->SetTextFont(42);
        l2->SetTextAlign(21);
        gr_ampl1->GetListOfFunctions()->Add(l2);
    TLatex  *l3 = new TLatex(position[2]-5.,ampl1[2]+30,Form("%i",3));
    ...
    TLatex  *l21 = new TLatex(position[0]-5.,ampl2[0]-40.,Form("%i",1));
...
*/
    ...
    lambda1.SetNDC();
    lambda1.DrawLatex(0.25, 0.82, tmp.str().c_str());
...
*/
    ...
    lambda2.SetNDC();
    lambda2.DrawLatex(0.59, 0.82, tmp.str().c_str());
